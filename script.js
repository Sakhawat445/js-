...
document.getElementById("ifnested").onclick=function(){
    ...
    if(userName==="Sakhawat"){
        let password = prompt("Enter Your password")
        if(password === "sakhawat"){
        ...
        document.getElementById("output").innerHTML="Wrong userNAme <br> Correct user name is Sakhawat"
    }
}
...
document.getElementById("login").onclick = function(){
    ...
    if(Username ==="Sakhawat"){
        if(Password==="sakhawat"){
            ...
            document.getElementById("output").innerHTML="incorrect password or username <br> use Sakhawat as username or sakhawat as password "
        }
    }
    else{
